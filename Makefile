...
js:
	...
	cp _build/default/src/bin/js.bc.js web/rstt.js
	chmod +w web/rstt.js
...
wasm:
	...
	cp _build/default/src/bin/wasm.bc.wasm.js web/rstt.js
	cp -r _build/default/src/bin/wasm.bc.wasm.assets web/
	chmod +w web/rstt.js web/wasm.bc.wasm.assets web/wasm.bc.wasm.assets/*
	git describe --always --tags HEAD > web/version.txt
	chmod +w web/version.txt
